	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Source" Type="Folder">
			<Item Name="UI Interaction" Type="Folder">
				<Item Name="Progress Bar UI.lvclass" Type="LVClass" URL="../Source/UI Interaction/Progress Bar UI/Progress Bar UI.lvclass"/>
				<Item Name="UI Interaction.lvclass" Type="LVClass" URL="../Source/UI Interaction/Interface/UI Interaction.lvclass"/>
			</Item>
			<Item Name="VIDoc Settings/Editor" Type="Folder">
				<Item Name="Locate Installed VIDoc Editors.vi" Type="VI" URL="../Source/Editors/Locate Installed VIDoc Editors.vi"/>
				<Item Name="VIDoc Settings Editor.vi" Type="VI" URL="../Source/Editors/VIDoc Settings Editor.vi"/>
				<Item Name="VIDoc Settings.lvclass" Type="LVClass" URL="../Source/Settings/VIDoc Settings/VIDoc Settings.lvclass"/>
				<Item Name="VIDocEditor.lvclass" Type="LVClass" URL="../Source/Editors/VIDoc Editor/VIDocEditor.lvclass"/>
			</Item>
			<Item Name="VIDoc Parsing.lvlib" Type="Library" URL="../Source/Parsing/VIDoc Parsing.lvlib"/>
			<Item Name="VIDoc Printer.lvlib" Type="Library" URL="../Source/Printer/VIDoc Printer.lvlib"/>
		</Item>
